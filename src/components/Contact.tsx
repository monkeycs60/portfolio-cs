...
const Contact = () => {
	...
	return (
		<div
			id='contact'
			className='w-[90%] lg:w-[65%] mx-auto font-poppins py-[5vh] flex flex-col'>
			...
			<div className='lg:w-[70%] 3xl:w-1/2  flex flex-wrap justify-center mx-auto my-[70px] lg:my-[120px] gap-8 2xl:text-xl'>
				<ContactButton
					Icon={Github}
