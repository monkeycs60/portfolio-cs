	...
	return (
		<>
			<div id='projects' className=' w-[65%] m-auto flex flex-col pt-[13vh]'>
				...
				<div className='pt-12'>
					<span className='font-poppins text-base 2xl:text-xl'>
				...
				<div className='flex flex-col gap-4'>
					<ProjectMockUp
						...
						macWidth={1092}
						macHeight={664}
						macClassName='absolute lg:-bottom-[70px] 2xl:bottom-0 -left-[80px] 2xl:left-[0px] 3xl:left-[200px] cursor-pointer hover:brightness-50 scale-[60%] 2xl:scale-[78%] 3xl:scale-100'
						iphoneSrc='/mobile-coworkez.png'
						iphoneAlt='my project Chiaroscuro mobile version'
						iphoneClassName='absolute scale-[20%] 2xl:scale-[32%] 3xl:scale-[40%] lg:-bottom-[410px] 2xl:-bottom-[310px] 3xl:-bottom-[340px] left-[520px] 2xl:left-[900px] 3xl:left-[1300px] cursor-pointer hover:brightness-50'
					/>
			...
			<div className=' w-[65%] m-auto p-4 flex flex-col '>
				<div className='flex flex-col gap-4 4xl:mb-[10vh]'>
					<ProjectMockUp
						...
						macWidth={1117}
						macHeight={664}
						macClassName='absolute lg:-bottom-[70px] 2xl:bottom-0 left-[130px] 2xl:left-[280px] 3xl:left-[580px] cursor-pointer hover:brightness-150 scale-[60%] 2xl:scale-[78%] 3xl:scale-100'
						iphoneSrc='/mobile-chiaroscuro.png'
						iphoneAlt='my project Chiaroscuro mobile version'
						iphoneClassName='absolute scale-[20%] 2xl:scale-[32%] 3xl:scale-[40%] -bottom-[420px] 2xl:-bottom-[310px] 3xl:-bottom-[340px] -left-[120px] 2xl:-left-[70px] 3xl:left-[60px] hover:brightness-125 cursor-pointer'
					/>
					<div className='flex flex-col justify-center items-center gap-4 font-poppins'>
						<h1 className='text-center text-3xl 2xl:text-4xl 3xl:text-5xl 3xl:mt-32 text-gray-cool-700'>
							Chiaroscuro
